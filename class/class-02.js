 ...
 *
 * 그러나 위 방식의 장점이라고 하면
 * getFullName이라고 하는 메서드를 보다 효율적으로 사용하기 위함이다.
 *
 * prototype을 통해 일반 함수를 할당해주면 되는데 주의할 점은 여기서 화살표 함수를 사용해선 안된다.
 * 왜냐하면, this라는 키워드의 정의가 달라지기 때문.
 */
