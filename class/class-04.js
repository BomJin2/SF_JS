...
const user1 = new User("Bomjin", "Kim");

console.log(user1);

user1.firstName = "babo";
...
const user2 = new NewUser("Bomjin", "Kim");
console.log(user2);
console.log(user2.fullName);

user2.firstName = "babo";

console.log(user2.fullName);

/** set이라는 키워드를 통해서 만든 fullName이라는 메서드는
 * 해당하는 fullName에다가 이렇게 할당연산자를 통해서 어떤 값을 지정하려고 할 때 동작하는 메서드라는 점
 */
